...
app.get('/api/myforecast/deliver', async function (req: any, res: any) {
...
app.get('/api/myforecast/', async function (req: any, res: any) {
    let myForecast = await weatherbot.getMyForecastMessage();
    console.log(myForecast);
    res.send(myForecast);
});

app.get('/api/updateMyLocation/', async function (req: any, res: any) {
...
app.get('/api/mylocation/', async function (req: any, res: any) {
    let location = iCloudLocate.readDeviceLocationFromFile();
    console.log(location);
    res.send(location);
});

app.post('/api/mylocation/', async (req: any, res: any) => {
